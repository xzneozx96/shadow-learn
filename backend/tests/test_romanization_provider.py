from app.lessons.services.romanization_provider import (
...
def test_english_provider_returns_nonempty_for_simple_word():
    ...
    from app.lessons.services.romanization_provider import EnglishRomanizationProvider
...
def test_get_romanization_provider_chinese():
    from app.lessons.services.romanization_provider import ChineseRomanizationProvider
...
def test_get_romanization_provider_fallback_to_null():
    from app.lessons.services.romanization_provider import NullRomanizationProvider
...
def test_japanese_provider_returns_nonempty_string():
    from app.lessons.services.romanization_provider import JapaneseRomanizationProvider
