...
export function OverallStatsPanel({ stats }: Props) {
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 h-full">
      {/* Card 1: Exercises */}
      <div className="group flex flex-col items-center justify-center p-6 text-center rounded-2xl border border-border/40 elegant-card backdrop-blur-xl shadow-xs relative overflow-hidden h-full">
