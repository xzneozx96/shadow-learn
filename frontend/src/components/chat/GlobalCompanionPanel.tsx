...
export function GlobalCompanionPanel() {
  ...
  return (
    <div className="relative z-5 w-[300px] xl:w-[400px] shrink-0 flex flex-col border-l border-border">
      <div className="h-[61px] flex items-center gap-2 border-b border-border px-3">
