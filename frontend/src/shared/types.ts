...
export interface WordBreakdown {
  word: string
  sourceLanguage: string
  characters: import('@/shared/lib/hanzi/types').CharData[]
  story: string | null
...
// Shared-kernel: consumed across study (ModePicker/quiz), agent (renderStudySession), and
// shared study utilities (study-utils, useTracking) — lives in shared so those may depend on it.
