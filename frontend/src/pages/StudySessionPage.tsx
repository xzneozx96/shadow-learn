...
export function StudySessionPage() {
  ...
  async function handleStart() {
    ...
    try {
      ...
      // Fallback to client-side exercises if AI fails
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-6 py-10 pb-20">
        ...
        {phase === 'session' && q && !loading && (
          <>
            {azureBanner && (
              <div className="text-xs text-amber-400 bg-amber-500/8 border border-amber-500/20 rounded-[var(--radius)] px-4 py-2.5 mb-4">
