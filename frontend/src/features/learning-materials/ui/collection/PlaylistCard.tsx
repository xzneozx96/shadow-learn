import type { PlaylistItem } from '@/features/learning-materials/domain/collection'
        ...
        <CutoutCard className={cn(cutoutCardSurfaceClassName, 'relative z-10 flex-1 select-none group/card cursor-pointer grid grid-rows-[auto_1fr]')}>
          <CutoutCardMedia className="aspect-video">
            ...
            {playlist.video_count !== null && (
              <CutoutCardPin className="top-0 right-0 rounded-bl-[16px] bg-card px-3 py-1 text-xs font-semibold text-amber-500 tabular-nums shadow-md ring-1 ring-border/40 flex items-center gap-1">
