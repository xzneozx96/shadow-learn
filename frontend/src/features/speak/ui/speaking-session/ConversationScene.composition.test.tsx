...
import type { SpeakSessionValue } from '@/features/speak/application/SpeakSessionContext'
import { render, screen } from '@testing-library/react'
import { describe, expect, it, vi } from 'vitest'
import { SpeakSessionProvider } from '@/features/speak/application/SpeakSessionContext'
import { ConversationScene } from '@/features/speak/ui/speaking-session/ConversationScene'
...
vi.mock('@/features/agent/ui/agents-ui/agent-control-bar', () => ({
  AgentControlBar: () => null,
}))

vi.mock('@/features/agent/ui/agents-ui/agent-audio-visualizer-aura', () => ({
  AgentAudioVisualizerAura: () => null,
}))

vi.mock('@/features/speak/application/useOnlineStatus', () => ({
