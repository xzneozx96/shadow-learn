...
import { buildGlobalSystemPrompt, buildSystemPrompt, clearSystemPromptCache, formatProgressSummary } from '@/features/agent/lib/agent-system-prompt'
...
describe('buildSystemPrompt', () => {
  ...
  it('includes today date when provided', () => {
    ...
    expect(prompt).toContain('Current Date: 2026-04-02')
  })
