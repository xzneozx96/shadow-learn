...
import type { SegmentResult } from '@/features/shadowing/domain/shadowing-utils'
import type { LessonMeta, Segment, ShadowingBest } from '@/shared/types'
import { useEffect, useState } from 'react'
import { useAuth } from '@/contexts/AuthContext'
import { useI18n } from '@/contexts/I18nContext'
import { saveSessionLog, upsertExerciseStat } from '@/db'
import { computeSessionSummary } from '@/features/shadowing/domain/shadowing-utils'
import { getLanguageCaps } from '@/shared/lib/language-caps'
import { captureShadowingSessionCompleted, captureShadowingSessionStarted } from '@/shared/lib/posthog-events'
