...
vi.mock('@/features/vocabulary/ui/WordPickerDialog', () => ({
...
vi.mock('@/features/study/ui/LessonPracticeModal', () => ({
...
vi.mock('@/features/vocabulary/ui/workbook/WordBreakdownModal', () => ({
  WordBreakdownModal: () => null,
}))

vi.mock('@/features/vocabulary/ui/RemoveVocabDialog', () => ({
